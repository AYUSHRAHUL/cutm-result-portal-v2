                ...
                <tbody>
                  {subjects.map((r,i) => (
                    <tr key={i} className="border-t border-white/10 hover:bg-white/10">
                      ...
                      <td className="px-3 py-2"><span className={`px-2 py-1 rounded-full text-xs ${isRedGrade(r.Grade) ? 'bg-rose-500/20 text-rose-200' : 'bg-emerald-500/20 text-emerald-200'}`}>{r.Grade}</span></td>
                    </tr>
                  ))}
                </tbody>
              </table>
                      ...
                      <tbody>
                        {r.subjects.map((s,i) => (
                          <tr key={i} className="border-t border-white/10 hover:bg-white/10">
                            ...
                            <td className="px-3 py-2"><span className={`px-2 py-1 rounded-full text-xs ${isRedGrade(s.Grade) ? 'bg-rose-500/20 text-rose-200' : 'bg-emerald-500/20 text-emerald-200'}`}>{s.Grade}</span></td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
